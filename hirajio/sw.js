...
self.addEventListener('fetch', e => {
  ...
  if (url.pathname.endsWith('episodes.json') || url.pathname.endsWith('members.json') || url.pathname.endsWith('kb.json') || url.pathname.endsWith('version.json')) {
