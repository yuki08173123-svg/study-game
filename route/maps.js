/* 極めた人のマップ（生徒が実際に使った 問題集マップ2・暗記マップ の原本）
   ...
   recs = その問題集を極めた人ごとの記録。1冊に何人ぶんでも並べられる。
   sum  = 期間・日数・周回数（日付と周回数はマップから読み取ったもの）。
...
const MAPS = {
  stock3000: { recs: [
    ...
    {
      sum: { from:'2/27', to:'6/11', days:105, span:'ちょうど15週間（約3ヶ月2週間）', rounds:'8周',
             note:'7周目までを5/11に終えて、そのあと8周目をもう1周' },
      items: [ { f:'stock3000-2', t:'問題集マップ2', d:'1〜8周目（毎回1〜1528を8日で1周）' } ]
    },
    {
      sum: { from:'3/3', to:'5/3', days:62, span:'約2ヶ月（8週間と6日）', rounds:'6周',
             note:'1周ごとの正答率は 84%→87%→92%→94%→96%→98%' },
      items: [ { f:'stock3000-3', t:'暗記マップ', d:'1〜6周目' } ]
    }
  ]},
  stock4500: { recs: [
    {
  ...
  polaris0: { recs: [
    ...
    {
      sum: { from:'3/3', to:'8/24', days:175, span:'ちょうど25週間（約5ヶ月3週間）', rounds:'4周',
             note:'3周目までを5/26に終えて、4周目は8/22〜8/24で一気に仕上げ' },
      items: [ { f:'polaris0-3', t:'問題集マップ2', d:'1〜4周目（C1〜C3とC4〜C5に分けて記録）' } ]
    },
    {
      sum: { from:'3/4', to:'6/11', days:100, span:'ちょうど100日（約3ヶ月1週間）', rounds:'4周',
             note:'3周目までを5/3に終えて、4周目は6/3〜6/11で一気に仕上げ' },
      items: [
        { f:'polaris0-4', t:'問題集マップ2', d:'1〜3周目（3/4〜4/18）' },
        { f:'polaris0-5', t:'問題集マップ2', d:'3〜4周目（4/23〜6/11）' }
      ]
    }
  ]},
  polaris1: { recs: [
  ...
  saikyou_gendai: { recs: [
    ...
    {
      sum: { from:'3/11', to:'6/8', days:90, span:'ちょうど90日（約3ヶ月）', rounds:'4周',
             note:'1周目 3/11〜3/25／2周目 3/30〜4/17／3周目 4/23〜5/3／4周目 6/3〜6/8' },
      items: [ { f:'saikyou_gendai-2', t:'問題集マップ2', d:'1〜4周目' } ]
    }
  ]},
  kijutsu: { recs: [
    {
  ...
  kisomon_ia: { recs: [
    ...
    {
      sum: { from:'3/3', to:'9/13', days:195, span:'約6ヶ月1週間', rounds:'4周',
             note:'1周目 3/3〜4/18／2周目 4/23〜8/1／3周目 8/3〜8/17／4周目 8/20〜9/13。5〜6月は学校の授業で学ぶ期間としていったん止めている' },
      items: [
        { f:'kisomon_ia-8',  t:'問題集マップ2', d:'1周目・問1〜81' },
        { f:'kisomon_ia-9',  t:'問題集マップ2', d:'1周目・問82〜154' },
        { f:'kisomon_ia-10', t:'問題集マップ2', d:'2周目・問1〜81' },
        { f:'kisomon_ia-11', t:'問題集マップ2', d:'2周目・問82〜154' },
        { f:'kisomon_ia-12', t:'問題集マップ2', d:'3周目・問1〜81' },
        { f:'kisomon_ia-13', t:'問題集マップ2', d:'3周目・問82〜154' },
        { f:'kisomon_ia-14', t:'問題集マップ2', d:'4周目・問1〜81' },
        { f:'kisomon_ia-15', t:'問題集マップ2', d:'4周目・問82〜154' }
      ]
    }
  ]}
};
