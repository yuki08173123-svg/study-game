...
BG1=(0xE2,0x5A,0x45); BG2=(0x8E,0x24,0x1A)
PAPER=(0xFF,0xFB,0xF6); RULE=(0xE3,0xD8,0xCC); RED=(0xD9,0x47,0x2F); GREEN=(0x1E,0x9E,0x6A); INK=(0x3B,0x1F,0x1A)
def grad(size):
...
def make(S, maskable=False):
    ...
    lay=Image.composite(Image.new('RGBA',(S,S),(60,10,5,255)),lay,sh); L=ImageDraw.Draw(lay)
    # 紙
    ...
    L.rectangle([P(210,215),P(770,300)],fill=(0xF5,0xEC,0xE2,255))
    # 1列目に ✕（赤）、2列目に改善の線
    ...
    for y,wd in ((395,360),(525,260),(655,320)):
        L.rounded_rectangle([P(370,y-16),P(370+wd,y+16)],radius=int(k(16)),fill=(0xC9,0xB8,0xA8,255))
    # 3行目は緑の○（極まった）
